...
HD_PWD='C:/Users/user/Desktop/verilog/Verilog/kit_verilog/Exercise2_GrayCode/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block.tcl -notrace
