...
HD_PWD='C:/Users/user/Desktop/verilog/Verilog/kit_verilog/Exercise1_4bit_2input_norgate/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log block2.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source block2.tcl -notrace
