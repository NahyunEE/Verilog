...
HD_PWD='C:/Users/user/Desktop/verilog/Verilog/kit_verilog/Exercise1_4bit_2input_norgate/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log block2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source block2.tcl
